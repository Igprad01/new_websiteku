        ...
        <footer data-aos='fade-up' className={`mx-auto py-40 bg-slate-900`}>
            <div className={`container mx-auto px-4 py-8 sm:px-6 lg:px-8`}>
                ...
                <div className={`my-12 mx-auto`}>
                    <Image src={`static/img/marin.png`} styleImg={`w-60 rounded-full`}/>
                    ...
                    <ExternalLink konten={'I Gusti Bagus Putra Pradwi'} href={''} styling={`text-xl sm:text-2xl md:text-3xl lg:text-3xl`} />
                    </div>
