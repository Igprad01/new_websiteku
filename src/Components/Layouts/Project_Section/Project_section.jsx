...
const Section_Project = () => {
    ...
    const card = [
        { id: 0, title: 'Financial Bot', teks: 'Bot Telegram untuk pencatatan keuangan otomatis yang terintegrasi dengan database untuk memudahkan manajemen finansial.', img: '/img/financialku.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton: 'Lihat Project', link: 'https://t.me/keuanganpribadiku_bot', stack: [stacksInfo.telegram, stacksInfo.nextjs, stacksInfo.mysql] },
        {id:1, title:'Catatanku', teks:'app catatan sederhana merupakan project pertama saya menggunakan laravel dan my sql digunakan untuk menyimpan catatan pribadi', img:'/img/catatanku.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'#', stack: [stacksInfo.laravel, stacksInfo.mysql, stacksInfo.php]},
        {id:3, title:'To Do List', teks:'aplikasi to do list sederhana merupakan project pertama saya menggunakan laravel dan my sql digunakan untuk menyimpan catatan pribadi', img:'/img/todolist.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'#', stack: [stacksInfo.laravel, stacksInfo.mysql, stacksInfo.php]},
        {id:4, title:'Sistem Parkir Mall', teks:'aplikasi sistem parkir mall merupakan project pertama saya menggunakan laravel dan my sql digunakan untuk menyimpan catatan pribadi', img:'/img/sistemparkirmall.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'#', stack: [stacksInfo.laravel, stacksInfo.mysql, stacksInfo.php]},
        {id:5, title:'Digital Idul Fitri & THR', teks:'Website seru-seruan buat ngucapin Selamat Idul Fitri. Nggak cuma banner ucapan biasa, di sini juga ada tombol rahasia yang isinya link Dana Kaget buat bagi-bagi THR beneran ke teman-teman!',img:'/img/idulFitri.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'https://idulfitri-nine.vercel.app/', stack: [stacksInfo.react, stacksInfo.tailwind, {name: 'DaisyUI', icon: daisyuiIcon}]},
        {id:6, title:'Visualisasi Peta Persebaran Gempa Di Jawa Barat ', teks:'Sebuah Project kelompok bersama temen-temen kuliah dengan tema visualisasi data gempa di Jawa Barat menggunakan data dump dari kaggle.com', img:'/img/peta.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'https://datastudio.google.com/s/qA_-MnGtm-Q', stack: [stacksInfo.lookerstudio, stacksInfo.excel]},
        {id:7, title:'App Patungan Makan', teks:'Suka pusing kalau habis nongkrong tapi bingung ngitung patungan? Nah, web app sederhana ini saya bikin khusus buat ngitung tagihan makan/nongkrong bareng supaya lebih cepat, gampang, dan adil.', img:'/img/Apppatungan.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'https://patunganapp.vercel.app/', stack: [stacksInfo.vue, stacksInfo.tailwind]},
        {id:8, title:'Slicing Landing Page Manajemen Kontrak', teks:'website dibuat ulang dengan desain yang lebih modern dan responsif dengan sumber dari desain yang saya dapat dari dribble', img:'/img/slicingdesain.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'https://slicing-website-two.vercel.app/', stack: [stacksInfo.vue, stacksInfo.tailwind]},
        {id:9, title:'Auto Random Color', teks:'Proyek iseng untuk belajar eksplorasi logika Javascript. Website ini langsung ngasih kombinasi warna-warna acak yang unik di layar cuma bermodal sekali klik. Simpel, tapi seru buat dilihat.', img:'/img/randomColor.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'https://auto-random-color.vercel.app/', stack: [stacksInfo.html, stacksInfo.css, stacksInfo.js]},
        {id:10, title:'Portofolio Versi Lama', teks:'Website portofolio pertama yang saya buat waktu awal-awal ngoding. Cocok buat nostalgia ngeliat skill dasar front-end dan beberapa project lawas saya.', img:'/img/newPortofolio.webp', stylingklik:'btn btn-outline btn-primary btn-sm sm:btn-md lg:btn-wide', kalimatButton:'Lihat Project', link:'https://putrapradwi.vercel.app/', stack: [stacksInfo.html, stacksInfo.css, stacksInfo.js]},
    ]

    return (
        <div data-aos="fade-up" className={`container mx-auto px-4 py-8  sm:px-6 lg:px-8`} id="project">
            <Heading2 Text={`Project`} Styling={`text-center text-2xl capitalize mb-10 sm:text-3xl md:text-4xl lg:text-5xl`}/>
