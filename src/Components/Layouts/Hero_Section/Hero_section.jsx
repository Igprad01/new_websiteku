...
const HeroSection= () => {
    return (
        <div className={`container mx-auto px-4 sm:px-6 lg:px-8 py-8`}>
            ...
            <Heading1 Text = 'putra pradwi.' Styling={`font-bold text-2xl mb-10 capitalize sm:text-3xl lg:text-6xl mb-6`} />
            <Heading2 Text = 'Front End Developer' Styling={`font-bold text-lg mb-10 sm:text-xl lg:text-4xl mb-7`} />
          <div>
