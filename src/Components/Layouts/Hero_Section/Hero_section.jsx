...
const HeroSection= () => {
    const TextRunning = ['front end developer', 'data analysis']
    ...
    return (
        <div className={`container mx-auto px-4 sm:px-6 lg:px-8 py-8`}>
            ...
            <Heading2 Text = {TextRunning[textIndex]} Styling={`font-bold capitalize text-lg mb-10 sm:text-xl lg:text-7xl mb-7`} />
          <div>
