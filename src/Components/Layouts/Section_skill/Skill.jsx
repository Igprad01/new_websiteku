...
const skill = () => {
    ...
    const cardSkill = [
        ...
        {id:1, img:'/Logo/tailwinds.png'},
        {id:1, img:'/Logo/laragon.png'},
        {id:1, img:'/Logo/wordpress.png'},
        {id:1, img:'/Logo/sheet.png'},
        {id:1, img:'/Logo/looker-studio.png'},
    ]

    return (
        <div className={`container mx-auto px-2 py-8 sm:px-2 lg:px-8`}>
